...
public class DisplayTester {
    ...
    public static void main(String[] args) {
        /*
         * int N = 10, M = 10; Cell[][] values = new Cell[N][M]; CandyGenerator
         * generator = new CandyGenerator(null); for (int i = 0; i < N; ++i) {
         * for (int j = 0; j < M; ++j) { values[i][j] = new Cell(null,
         * generator.getCandy()); } }
         */
        ...
        controlPanel.setBorder(
                BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED), "Save Panel"));
