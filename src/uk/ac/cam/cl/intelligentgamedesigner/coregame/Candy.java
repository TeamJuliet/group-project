...
public class Candy implements Cloneable, Serializable {
     ...
     * 
     * @param radius
     *            of the wrapped candy that is being detonated. That should
     *            either be 3, 1 or 0 (which are included in the GameConstants
     *            as DOUBLE_WRAPPED_RADIUS_B, SINGLE_WRAPPED_RADIUS and
     *            DOUBLE_WRAPPED_RADIUS_A respectively).
     */
    ...
    public boolean equals(Object toCompare) {
        ...
        return (this.colour == candyToCompare.colour && this.candyType == candyToCompare.candyType
                ...
                && this.wrappedDetonationRadius == candyToCompare.wrappedDetonationRadius);
    }
