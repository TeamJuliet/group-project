...
public enum CandyType {
	/**
	 * Simple candy without any detonation effects.
	 */
	NORMAL,

	/**
	 * Vertically stripped special candy.
	 */
	VERTICALLY_STRIPPED,

	/**
	 * Horizontally stripped special candy.
	 */
	HORIZONTALLY_STRIPPED,

	/**
	 * Wrapped special candy.
	 */
	WRAPPED,

	/**
	 * Colour Bomb. Does not have a candy colour.
	 */
	BOMB,

	/**
	 * Ingredient. Does not have a candy colour.
	 */
	INGREDIENT,

	/**
	 * Does not have a candy colour and it is used to get next partially known
	 * states.
	 */
	UNMOVABLE, ;
	...
	public boolean isSpecial() {
		return this == HORIZONTALLY_STRIPPED || this == VERTICALLY_STRIPPED
				|| this == WRAPPED;
	}
