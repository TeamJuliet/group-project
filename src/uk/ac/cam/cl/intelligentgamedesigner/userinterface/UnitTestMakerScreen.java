...
public class UnitTestMakerScreen extends DisplayScreen implements ChangeListener{
	...
	//populates the interface with a saved level for editing
	public void reload(TestCaseGame test) {
		...
		} else { //if no design, reset the screen
	...
	//edit the board in relation to the sliders
	@Override
	...
	//make the unit test and save it.
