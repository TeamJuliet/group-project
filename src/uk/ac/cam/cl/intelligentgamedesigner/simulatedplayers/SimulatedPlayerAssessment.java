...
/**
 * 
 * Class that is responsible for the assessment of players based on the records of several players.
 *
 */
public class SimulatedPlayerAssessment {
    ...
    public static double getScorePlayerAssessment(PlayerAssessmentRecord playerRecordsToAssess, List<PlayerAssessmentRecord> otherPlayers) {
        ...
        return sanitizePercentage(percentage + PERCENTAGE_BOOST * (averageGamesWon * movesDelta + scoreDelta * (1.0 - averageGamesWon))); 
    }
    
    public static PlayerAssessmentRecord getScorePlayerAssessmentRecord(List<GameStateProgress> progressRecords, Design design) {
