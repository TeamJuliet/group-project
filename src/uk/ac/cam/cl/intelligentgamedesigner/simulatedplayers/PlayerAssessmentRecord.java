...
public class PlayerAssessmentRecord implements Serializable {
	...
	public double getAverageGamesWon() {
		return ((double) this.numOfGamesWon)
				/ (this.numOfGamesWon + (double) this.numOfGamesLost);
	}

	public PlayerAssessmentRecord(int numOfGamesWon, int numOfGamesLost,
			double normalizedAverageScore, double averageRemainingMoves) {
